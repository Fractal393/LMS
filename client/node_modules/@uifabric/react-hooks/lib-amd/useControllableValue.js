define(["require", "exports", "react", "./useConst", "./useConstCallback"], function (require, exports, React, useConst_1, useConstCallback_1) {
    "use strict";
    ...
    function useControllableValue(controlledValue, defaultUncontrolledValue, onChange) {
        ...
        var setValueOrCallOnChange = useConstCallback_1.useConstCallback(function (update, ev) {
