...
export var SelectedPeopleListBasicExample = function () {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Stack, { horizontal: true, wrap: true },
            React.createElement(SelectedPeopleList, { key: "normal", removeButtonAriaLabel: "Remove", defaultSelectedItems: [people[40]], componentRef: selectionList, onCopyItems: onCopyItems, 
                // eslint-disable-next-line react/jsx-no-bind
