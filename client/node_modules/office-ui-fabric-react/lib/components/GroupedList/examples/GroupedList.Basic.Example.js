...
export var GroupedListBasicExample = function () {
    ...
    var onRenderCell = function (nestingDepth, item, itemIndex) {
        return item && itemIndex ? (React.createElement(DetailsRow, { columns: columns, groupNestingDepth: nestingDepth, item: item, itemIndex: itemIndex, selection: selection, selectionMode: SelectionMode.multiple, compact: isCompactMode })) : null;
    };
