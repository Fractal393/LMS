...
export var PeoplePickerLimitedSearchExample = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(CompactPeoplePicker
        /* eslint-disable react/jsx-no-bind */
        , { 
            /* eslint-disable react/jsx-no-bind */
            onResolveSuggestions: onFilterChangedWithLimit, onEmptyInputFocus: returnMostRecentlyUsedWithLimit, getTextFromItem: getTextFromItem, className: 'ms-PeoplePicker', onGetMoreResults: onFilterChanged, pickerSuggestionsProps: limitedSearchSuggestionProps, onRemoveSuggestion: onRemoveSuggestion, 
        ...
        React.createElement(Checkbox, { label: "Disable People Picker", checked: isPickerDisabled, 
            // eslint-disable-next-line react/jsx-no-bind
            onChange: onDisabledButtonClick, styles: checkboxStyles }),
        React.createElement(Checkbox, { label: "Delay Suggestion Results", defaultChecked: delayResults, 
            // eslint-disable-next-line react/jsx-no-bind
