...
var HorizontalStackConfigureExampleContent = function (props) {
    ...
    return (React.createElement(Stack, { horizontal: true, wrap: wrap, disableShrink: disableShrink, horizontalAlign: horizontalAlignment, verticalAlign: verticalAlignment, styles: stackStyles, tokens: exampleStackTokens }, range(1, numItems).map(function (value, index) {
...
export var HorizontalStackConfigureExample = function () {
    ...
    var _c = useBoolean(false), wrap = _c[0], toggleWrap = _c[1].toggle;
    var _d = useBoolean(false), preventOverflow = _d[0], togglePreventOverflow = _d[1].toggle;
    ...
    return (React.createElement(Stack, { tokens: sectionStackTokens },
        React.createElement(Stack, { horizontal: true, disableShrink: true },
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Stack, null,
                    React.createElement(Slider, { label: "Number of items:", min: 1, max: 30, step: 1, defaultValue: 5, showValue: true, onChange: setNumItems }),
                    React.createElement(Stack, { horizontal: true, disableShrink: true },
                        React.createElement(Checkbox, { label: "Shadow around items", onChange: toggleShowBoxShadow, styles: shadowItemCheckboxStyles }),
                        React.createElement(Checkbox, { label: "Prevent item overflow", onChange: togglePreventOverflow })))),
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Stack, { horizontal: true, disableShrink: true, tokens: configureStackTokens },
                    React.createElement(Stack, null,
                        React.createElement(Checkbox, { label: "Wrap items", onChange: toggleWrap, styles: wrapItemCheckboxStyles }),
                        React.createElement(Checkbox, { label: "Shrink items", onChange: toggleDisableShrink })),
                    React.createElement(Stack.Item, { grow: true },
                        React.createElement(Slider, { label: "Container width:", min: 1, max: 100, step: 1, defaultValue: 100, showValue: true, onChange: setWrapperWidth }))))),
        React.createElement(Stack, { horizontal: true, disableShrink: true, tokens: configureStackTokens },
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Stack, null,
                    React.createElement(Slider, { label: "Horizontal gap between items:", min: 0, max: 50, step: 1, defaultValue: 0, showValue: true, onChange: setColumnGap }),
                    React.createElement(Slider, { label: "Vertical gap between items:", min: 0, max: 50, step: 1, defaultValue: 0, showValue: true, onChange: setRowGap }))),
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Stack, null,
        ...
        React.createElement(Stack, { horizontal: true, disableShrink: true, verticalAlign: "end", tokens: configureStackTokens },
            ...
            React.createElement(Stack.Item, { grow: true },
                React.createElement(TextField, { label: "Enter a space-separated list of empty children (e.g. 1 2 3):", 
                    // eslint-disable-next-line react/jsx-no-bind
        ...
        React.createElement(HorizontalStackConfigureExampleContent, __assign({}, {
            numItems: numItems,
