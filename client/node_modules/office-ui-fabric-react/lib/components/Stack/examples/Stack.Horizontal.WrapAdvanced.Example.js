...
var HorizontalStackWrapAdvancedExampleContent = function (props) {
    ...
    return (React.createElement("div", { style: containerStyles },
        React.createElement(Stack, { horizontal: true, verticalFill: true, wrap: true, horizontalAlign: horizontalAlignment, verticalAlign: verticalAlignment, styles: stackStyles, tokens: wrapStackTokens }, range(1, 10).map(function (n) { return (React.createElement("span", { style: itemStyles, key: n }, n)); }))));
};
export var HorizontalStackWrapAdvancedExample = function () {
    ...
    return (React.createElement(Stack, { tokens: sectionStackTokens },
        React.createElement(Stack, { horizontal: true },
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Slider, { label: "Stack width:", min: 1, max: 100, step: 1, defaultValue: 100, showValue: true, onChange: setStackWidth })),
            React.createElement(Stack.Item, { grow: true },
                React.createElement(Slider, { label: "Container height:", min: 1, max: 200, step: 1, defaultValue: 150, showValue: true, onChange: setContainerHeight }))),
        ...
        React.createElement(HorizontalStackWrapAdvancedExampleContent, __assign({}, { stackWidth: stackWidth, containerHeight: containerHeight, horizontalAlignment: horizontalAlignment, verticalAlignment: verticalAlignment, overflow: overflow }))));
};
