...
export var RatingButtonControlledExample = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(Rating, { rating: currentRating, max: 5, readOnly: true, allowZeroStars: true, 
            // eslint-disable-next-line react/jsx-no-bind
            getAriaLabel: getRatingAriaLabel, ariaLabelFormat: 'Select {0} of {1} stars' }),
        React.createElement(PrimaryButton, { text: 'Click to change rating to ' + (5 - currentRating), 
            // eslint-disable-next-line react/jsx-no-bind
