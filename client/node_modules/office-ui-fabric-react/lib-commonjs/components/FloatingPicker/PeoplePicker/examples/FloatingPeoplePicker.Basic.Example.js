...
exports.FloatingPeoplePickerTypesExample = function () {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: searchBoxWrapperStyling, ref: inputElementRef },
            React.createElement(SearchBox_1.SearchBox, { placeholder: "Search for person", 
                // eslint-disable-next-line react/jsx-no-bind
                onChange: onSearchChange, value: searchValue, 
                // eslint-disable-next-line react/jsx-no-bind
                onFocus: onFocus })),
        React.createElement(FloatingPicker_1.FloatingPeoplePicker, { suggestionsStore: suggestionsStore, 
            // eslint-disable-next-line react/jsx-no-bind
