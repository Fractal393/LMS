...
exports.VerticalStackWrapAdvancedExample = function () {
    ...
    return (React.createElement(Stack_1.Stack, { tokens: sectionStackTokens },
        React.createElement(Stack_1.Stack, { horizontal: true },
            React.createElement(Stack_1.Stack.Item, { grow: true },
                React.createElement(Slider_1.Slider, { label: "Stack height:", min: 1, max: 420, step: 1, defaultValue: 420, showValue: true, onChange: setContainerHeight })),
            React.createElement(Stack_1.Stack.Item, { grow: true },
                React.createElement(Slider_1.Slider, { label: "Container width:", min: 1, max: 100, step: 1, defaultValue: 100, showValue: true, onChange: setStackWidth }))),
        ...
        React.createElement(VerticalStackWrapAdvancedExampleContent, tslib_1.__assign({}, { stackWidth: stackWidth, containerHeight: containerHeight, horizontalAlignment: horizontalAlignment, verticalAlignment: verticalAlignment, overflow: overflow }))));
};
