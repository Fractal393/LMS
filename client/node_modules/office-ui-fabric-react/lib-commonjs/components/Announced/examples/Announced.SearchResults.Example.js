...
exports.AnnouncedSearchResultsExample = function () {
    ...
    var onFilterChanged = react_hooks_1.useConstCallback(function (filterText, tagList) {
    ...
    return (React.createElement(Stack_1.Stack, { tokens: stackTokens },
        ...
        hasFilterText && React.createElement(Announced_1.Announced, { message: suggestionCount + " color tag" + (suggestionCount === 1 ? '' : 's') + " found" }),
