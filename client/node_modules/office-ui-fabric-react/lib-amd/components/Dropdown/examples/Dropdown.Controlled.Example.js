define(["require", "exports", "react", "office-ui-fabric-react/lib/Dropdown"], function (require, exports, React, Dropdown_1) {
    ...
    exports.DropdownControlledExample = function () {
        ...
        return (React.createElement(Dropdown_1.Dropdown, { label: "Controlled example", selectedKey: selectedItem ? selectedItem.key : undefined, 
            // eslint-disable-next-line react/jsx-no-bind
            onChange: onChange, placeholder: "Select an option", options: dropdownControlledExampleOptions, styles: dropdownStyles }));
    };
});
