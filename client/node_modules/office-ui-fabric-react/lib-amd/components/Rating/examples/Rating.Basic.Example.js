define(["require", "exports", "react", "office-ui-fabric-react/lib/Rating", "office-ui-fabric-react/lib/Styling"], function (require, exports, React, Rating_1, Styling_1) {
    ...
    exports.RatingBasicExample = function () {
        ...
        return (React.createElement("div", null,
            "Large Stars:",
            React.createElement(Rating_1.Rating, { min: 1, max: 5, size: Rating_1.RatingSize.Large, rating: largeStarRating, getAriaLabel: getRatingComponentAriaLabel, 
                // eslint-disable-next-line react/jsx-no-bind
                onChange: onLargeStarChange, ariaLabelFormat: 'Select {0} of {1} stars' }),
            "Small Stars",
            React.createElement(Rating_1.Rating, { id: "small", min: 1, max: 5, rating: smallStarRating, 
                // eslint-disable-next-line react/jsx-no-bind
                onChange: onSmallStarChange, getAriaLabel: getRatingComponentAriaLabel, ariaLabelFormat: 'Select {0} of {1} stars' }),
            "10 Small Stars",
            React.createElement(Rating_1.Rating, { min: 1, max: 10, rating: tenStarRating, 
                // eslint-disable-next-line react/jsx-no-bind
            ...
            "Custom icons:",
            React.createElement(Rating_1.Rating, { min: 1, max: 5, rating: customIconStarRating, 
                // eslint-disable-next-line react/jsx-no-bind
            ...
            "Themed star",
            React.createElement(Rating_1.Rating, { min: 1, max: 5, rating: themedStarRating, 
                // eslint-disable-next-line react/jsx-no-bind
