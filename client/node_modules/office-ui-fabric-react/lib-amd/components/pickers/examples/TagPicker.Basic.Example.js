define(["require", "exports", "react", "office-ui-fabric-react/lib/Pickers", "office-ui-fabric-react/lib/Toggle", "office-ui-fabric-react/lib/Styling", "@uifabric/react-hooks"], function (require, exports, React, Pickers_1, Toggle_1, Styling_1, react_hooks_1) {
    "use strict";
    ...
    exports.TagPickerBasicExample = function () {
        // All pickers extend from BasePicker specifying the item type.
        var picker = React.useRef(null);
        var _a = react_hooks_1.useBoolean(false), tagPicker = _a[0], toggleIsTagPickerVisible = _a[1].toggle;
        ...
        return (React.createElement("div", { className: rootClass },
            React.createElement(Toggle_1.Toggle, { styles: toggleStyles, label: "Disable tag picker", checked: tagPicker, onChange: toggleIsTagPickerVisible }),
            "Filter items in suggestions: This picker will filter added items from the search suggestions.",
            React.createElement(Pickers_1.TagPicker, { removeButtonAriaLabel: "Remove", onResolveSuggestions: filterSuggestedTags, getTextFromItem: getTextFromItem, pickerSuggestionsProps: pickerSuggestionsProps, itemLimit: 2, disabled: tagPicker, inputProps: inputProps }),
            React.createElement("br", null),
            "Filter items on selected: This picker will show already-added suggestions but will not add duplicate tags.",
            React.createElement(Pickers_1.TagPicker, { removeButtonAriaLabel: "Remove", componentRef: picker, onResolveSuggestions: filterSelectedTags, onItemSelected: onItemSelected, getTextFromItem: getTextFromItem, pickerSuggestionsProps: pickerSuggestionsProps, itemLimit: 2, disabled: tagPicker, inputProps: inputProps })));
    };
});
