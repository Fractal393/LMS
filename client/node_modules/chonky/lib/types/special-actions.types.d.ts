...
export declare enum SpecialAction {
...
export interface SpecialSimpleAction {
    actionId: SpecialAction.OpenParentFolder | SpecialAction.ToggleSearchBar | SpecialAction.SelectAllFiles | SpecialAction.ClearSelection;
}
export declare type SpecialActionData = SpecialFileMouseClickAction | SpecialFileKeyboardClickAction | SpecialOpenFolderChainFolderAction | SpecialDragNDropStartAction | SpecialDragNDropEndAction | SpecialSimpleAction;
export declare type InternalSpecialActionDispatcher = (actionData: SpecialActionData) => void;
export declare type SpecialActionHandlerMap = {
